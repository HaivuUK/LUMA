...
<p align="center">
  <a href="https://doi.org/10.5281/zenodo.21432058">
    <img src="https://zenodo.org/badge/1269361937.svg" alt="DOI">
  </a>
...
<p align="center">
  <a href="https://github.com/HaivuUK/LUMA/releases/latest">Download</a> |
  <a href="https://luma.haivu.org">Documentation</a> |
...
If you use this software in your research, please cite the [LUMA citation file](https://github.com/HaivuUK/LUMA/blob/main/CITATION.cff).
...
For more information, please see the [LUMA Documentation](https://HaivuUK.github.io/LUMA/).
...
The compiled installers are available in the [release](https://github.com/HaivuUK/LUMA/releases/latest) 
...
2. **Mesh Loading**: Parse Abaqus (.inp), ANSYS (.cdb), FeBIO (.feb), or VTK (.vtk/.vtu) mesh files
